...
describe('ChatBubbleComponent', () => {
  ...
  let fixture: Awaited<
    ReturnType<typeof render<ChatBubbleComponent>>
  >['fixture'];
  ...
  it('should render the message text', () => {
    ...
    fixture.detectChanges();
    const message = queryElement('.agentjds-chat-bubble__message');
  ...
  it('should show meta info when author and timestamp are provided', () => {
    ...
    fixture.detectChanges();
    const meta = queryElement('.agentjds-chat-bubble__meta');
